...
export default function SettingsPanel({ previewRef }: SettingsPanelProps) {
  ...
  return (
    <div className="w-full px-4 py-3 bg-background border-t">      
      <div className="flex flex-wrap items-center gap-8">
        {/* Style (Font) Selection */}
        <div className="flex-1 min-w-[180px]">
          <Label htmlFor="font-select" className="text-sm font-medium mb-1.5">Style</Label>
          <Popover>
        ...
        <div className="flex-1 min-w-[180px]">
          <Label className="text-sm font-medium mb-1.5">Stroke Color</Label>
          <RadioGroup
            value={strokeColor}
